    ...
    return (
        <div className="bg-black min-h-screen">
            ...
            <div className="border-b border-white/10 bg-white/[0.02] py-8 w-full overflow-hidden">
                <AnimateOnScroll animation="fade-in" className="container grid grid-cols-2 md:grid-cols-4 gap-8">
                    {[
            ...
            <section className="section-padding bg-black relative">
                <div className="container">
                    <AnimateOnScroll className="text-center mb-16 px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {features.map((feature, index) => (
                            <AnimateOnScroll key={index} delay={index * 0.1} animation="fade-up">
                                <div className="glass-panel p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:border-gold hover:shadow-[0_10px_30px_rgba(255,215,0,0.15)] bg-white/[0.03] group h-full">
            ...
            <section className="section-padding bg-gray-dark">
                <div className="container">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <AnimateOnScroll animation="slide-left" className="order-1 lg:order-2 relative px-4 lg:px-0">
                ...
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
                        {products.map((product, index) => (
                            <AnimateOnScroll key={index} delay={index * 0.15} animation="scale-up" className="h-full">
                                <div className="glass-panel p-8 md:p-10 flex flex-col items-center text-center hover:-translate-y-2 hover:border-gold hover:shadow-[0_10px_40px_rgba(255,215,0,0.1)] transition-all duration-300 group bg-gray-light/40 h-full">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
                        {[
                            ...
                            <AnimateOnScroll key={index} delay={index * 0.1}>
                                <div className="glass-panel p-8 flex items-start gap-6 hover:-translate-y-1 transition-transform duration-300 bg-white/[0.02] h-full">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {[
                            ...
                            <AnimateOnScroll key={i} delay={i * 0.1}>
                                <div className="glass-panel p-8 relative bg-gray-light/30 flex flex-col h-full hover:bg-gray-light/50 transition-colors duration-300">
            ...
            {/* Awards Section */}
            <section className="section-padding bg-gray-dark border-t border-white/5">
                <div className="container">
                    <AnimateOnScroll className="text-center mb-16 px-4">
                    ...
                    <AnimateOnScroll animation="fade-up" className="flex flex-wrap justify-center gap-8 md:gap-12 opacity-80 hover:opacity-100 transition-opacity duration-300">
                        {[
